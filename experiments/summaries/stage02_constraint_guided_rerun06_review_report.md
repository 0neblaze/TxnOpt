# stage02_constraint_guided_rerun06
...
- `operator_event_artifacts_complete`: **pass** — observed=event_csv=1, failure_csv=1, event_rows=233731, failure_rows=198453; expected=one operator event CSV and one failure event CSV.
