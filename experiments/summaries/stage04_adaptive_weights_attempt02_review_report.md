...
- Run label: `stage04_adaptive_weights_attempt02`
- Scope: `formal`
...
| Gate | Status | Details |
|------|--------|---------|
| operator_call_sufficiency | PASS | all wall_clock axes have sufficient operator calls |
| six_category_statistics | PASS | all adaptive_wall_clock axes have accepted and rejected moves |
...
| replay_consistency | PASS | all 144 axes valid with matching objectives |
