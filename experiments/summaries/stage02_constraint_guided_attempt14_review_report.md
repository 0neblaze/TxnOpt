# stage02_constraint_guided_attempt14
...
- `operator_event_artifacts_complete`: **pass** — observed=event_csv=1, failure_csv=1, event_rows=200645, failure_rows=165381; expected=one operator event CSV and one failure event CSV.
