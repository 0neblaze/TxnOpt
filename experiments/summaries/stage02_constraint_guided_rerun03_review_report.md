# stage02_constraint_guided_rerun03
...
- `operator_event_artifacts_complete`: **pass** — observed=event_csv=1, failure_csv=1, event_rows=203304, failure_rows=168218; expected=one operator event CSV and one failure event CSV.
...
- `independent_complete_rerun_replay`: **pass** — observed={'status': 'pass', 'first_raw_revalidated': True, 'first_gate_pass': True, 'second_gate_pass': True, 'configuration_match': True}; expected=repeatability evidence and both complete runs are independently verified.
