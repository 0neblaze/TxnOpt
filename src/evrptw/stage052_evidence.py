...
def verify_stage052_source_snapshot(root: Path) -> dict[str, object]:
    ...
    allowed_local_files = {
        ...
        "configs/stage052_resource_calibration.local.review.json",
        "configs/stage052_resource_calibration.local.review.json.sha256",
        "configs/stage052_resource_calibration.local.sha256",
        "configs/stage052_calibration_successor.local.json",
        "configs/stage052_calibration_successor.local.sha256",
